...
import franchise from '../assets/images/ariha_ franchise.pdf';
import catelog from '../assets/images/ariha_catlg.pdf';
          ...
          <Row className='d-flex'>
            ...
            <Col xs={12} md={4} className="text-center text-md-start mb-4 mb-md-0">
              ...
              <div className="d-flex flex-column flex-md-row gap-2 justify-content-center justify-content-md-start">
               ...
               <a href={catelog}  ><MdOutlineFileDownload className="me-2" />
                  Be Our Franchisee</a>   
                </Button>
                <Button className='yellowbutton'>
                  <a href={franchise}>  <MdOutlineFileDownload className="me-2" />
                  Download Brochure</a>
            ...
            <Col xs={12} md={2} className="text-center text-md-start mb-4 mb-md-0">
              ...
              <p><Link to="/shop">Brownies</Link></p>
              <p><Link to="/shop">Buns & Loaves</Link></p>
              <p><Link to="/shop">Muffins</Link></p>
              <p><Link to="/shop">Pizza Bases</Link></p>
            </Col>
            ...
            <Col xs={12} md={4} className="text-center text-md-start">
              ...
              <div className='d-flex justify-content-center justify-content-md-start pb-2'>
                <LuPhone size={24} className='me-2' /> +91 9884455605
              </div>
              <div className='d-flex justify-content-center justify-content-md-start pb-2'>
                <CiMail size={24} className='me-2' /> wecare@arihafoods.com
              </div>
